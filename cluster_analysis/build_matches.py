...
<div class="wrap">
 <div class="mapwrap"><iframe src="./?embed=1" title="الخريطة"></iframe></div>
 ...
 <div class="muted" style="margin-top:12px">المباريات بنظام الدوري من دور واحد (ن×(ن−1)÷2)، للمجموعات المكتملة فقط (٦ فرق فأكثر).</div>
</div>
<script>
const MD=__MDATA__;
let cur=MD.ages[0];
