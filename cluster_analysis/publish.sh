...
python3 cluster_analysis/build_offices.py >/dev/null
...
cp cluster_analysis/offices.html /tmp/_pub_offices.html
cp cluster_analysis/offices.html docs/offices.html
...
cp /tmp/_pub_offices.html clusters/offices.html
[ -f /tmp/_pub_logo.png ] && cp /tmp/_pub_logo.png clusters/logo.png && git add clusters/logo.png
git add clusters/index.html clusters/dashboard.html clusters/dashboard_view.html clusters/matches.html clusters/players.html clusters/split.html clusters/offices.html
